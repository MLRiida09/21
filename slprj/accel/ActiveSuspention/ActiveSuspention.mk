...
MODEL              = ActiveSuspention
MODULES            = ActiveSuspention_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE           = ActiveSuspention.mk
...
MODELLIB                  = ActiveSuspentionlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/ActiveSuspention \
	-I$(START_DIR) \
	-ID:/matlab/matlab2/Final \
